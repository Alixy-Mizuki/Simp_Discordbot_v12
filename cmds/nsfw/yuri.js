...
module.exports = class NS_yuriCommand extends Command { //MeowCommand
	constructor(client) {
		super(client, {
			name: 'yuri',
			aliases: [], 
...
//
  ...
  try
  {
    ...
    {
      return message.channel.send(new MessageAttachment(await AKN.nsfw.yuri(), "yuri.jpg"))
    }
    if(Count > 1) 
    {
      let userMSG = message;
      ...
      for(let i = 0; i < Count; i++)
      {
        ...
        .setFile(await AKN.nsfw.yuri(), `yuri-${i}.jpg`)
        Images.push(IMG)
      }
