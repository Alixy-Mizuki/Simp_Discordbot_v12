...
module.exports = class NS_FeetCommand extends Command { //MeowCommand
	constructor(client) {
		super(client, {
			name: 'feet',
			aliases: [], 
...
//
  ...
  try
  {
    ...
    {
      return message.channel.send(new MessageAttachment(await AKN.nsfw.feet(), "feet.jpg"))
    }
    if(Count > 1) 
    {
      let userMSG = message;
      ...
      for(let i = 0; i < Count; i++)
      {
        ...
        .setFile(await AKN.nsfw.feet(), `feet-${i}.jpg`)
        Images.push(IMG)
      }
