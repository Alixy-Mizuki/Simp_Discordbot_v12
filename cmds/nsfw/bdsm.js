...
module.exports = class NS_bdsmCommand extends Command { //MeowCommand
	constructor(client) {
		super(client, {
			name: 'bdsm',
			aliases: [], 
...
//
  ...
  try
  {
    ...
    {
      return message.channel.send(new MessageAttachment(await AKN.nsfw.bdsm(), "bdsm.jpg"))
    }
    if(Count > 1) 
    {
      let userMSG = message;
      ...
      for(let i = 0; i < Count; i++)
      {
        ...
        .setFile(await AKN.nsfw.bdsm(), `bdsm-${i}.jpg`)
        Images.push(IMG)
      }
