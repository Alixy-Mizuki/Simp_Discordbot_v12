...
module.exports = class NS_tentaclesCommand extends Command { //MeowCommand
	constructor(client) {
		super(client, {
			name: 'tentacles',
			aliases: [], 
      ...
      examples: ['tentacles <count | default: 1>'],
      guildOnly: true,
      hidden: true,
      nsfw: true,
      throttling: 
...
//
  ...
  try
  {
    ...
    {
      return message.channel.send(new MessageAttachment(await AKN.nsfw.tentacles(), "tentacles.jpg"))
    }
    if(Count > 1) 
    {
      let userMSG = message;
