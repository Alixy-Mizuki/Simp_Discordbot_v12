...
module.exports = class NS_orgyCommand extends Command { //MeowCommand
	constructor(client) {
		super(client, {
			name: 'orgy',
			aliases: [], 
...
//
  ...
  try
  {
    ...
    {
      return message.channel.send(new MessageAttachment(await AKN.nsfw.orgy(), "orgy.jpg"))
    }
    if(Count > 1) 
    {
      let userMSG = message;
      ...
      for(let i = 0; i < Count; i++)
      {
        ...
        .setFile(await AKN.nsfw.orgy(), `orgy-${i}.jpg`)
        Images.push(IMG)
      }
