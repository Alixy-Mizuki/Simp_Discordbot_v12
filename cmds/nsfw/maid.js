...
module.exports = class NS_maidCommand extends Command { //MeowCommand
	constructor(client) {
		super(client, {
			name: 'maid',
			aliases: [], 
...
//
  ...
  try
  {
    ...
    {
      return message.channel.send(new MessageAttachment(await AKN.nsfw.maid(), "maid.jpg"))
    }
    if(Count > 1) 
    {
      let userMSG = message;
      ...
      for(let i = 0; i < Count; i++)
      {
        ...
        .setFile(await AKN.nsfw.maid(), `maid-${i}.jpg`)
        Images.push(IMG)
      }
