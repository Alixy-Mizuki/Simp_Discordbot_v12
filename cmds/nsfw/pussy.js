...
module.exports = class NS_pussyCommand extends Command { //MeowCommand
	constructor(client) {
		super(client, {
			name: 'pussy',
			aliases: [], 
      ...
      examples: ['pussy <count | default: 1>'],
      guildOnly: true,
      hidden: true,
      nsfw: true,
      throttling: 
...
//
  ...
  try
  {
    ...
    {
      return message.channel.send(new MessageAttachment(await AKN.nsfw.pussy(), "pussy.jpg"))
    }
    if(Count > 1) 
    {
      let userMSG = message;
      ...
      for(let i = 0; i < Count; i++)
      {
        ...
        .setFile(await AKN.nsfw.pussy(), `pussy-${i}.jpg`)
        Images.push(IMG)
      }
