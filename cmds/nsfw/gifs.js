...
module.exports = class NS_gifsCommand extends Command { //MeowCommand
	constructor(client) {
		super(client, {
			name: 'gifs',
			aliases: ['gif'], 
...
//
  ...
  try
  {
    ...
    {
      return message.channel.send(new MessageAttachment(await AKN.nsfw.gifs(), "gifs.gif"))
    }
    if(Count > 1) 
    {
      let userMSG = message;
      ...
      for(let i = 0; i < Count; i++)
      {
        ...
        .setFile(await AKN.nsfw.gifs(), `gifs-${i}.gif`)
        Images.push(IMG)
      }
