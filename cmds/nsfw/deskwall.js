...
module.exports = class NS_deskwallCommand extends Command { //MeowCommand
	constructor(client) {
		super(client, {
			name: 'deskwall',
			aliases: [], 
      ...
      examples: ['deskwall <count | default: 1>'],
      guildOnly: true,
      hidden: true,
      nsfw: true,
      throttling: 
...
//
  ...
  try
  {
    ...
    {
      return message.channel.send(new MessageAttachment(await AKN.nsfw.wallpapers(), "Desktop.jpg"))
    }
    if(Count > 1) 
    {
      let userMSG = message;
