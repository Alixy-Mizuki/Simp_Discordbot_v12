...
module.exports = class NS_AssCommand extends Command { //MeowCommand
	constructor(client) {
		super(client, {
			name: 'ass',
			aliases: [], 
...
//
  ...
  try
  {
    ...
    {
      return message.channel.send(new MessageAttachment(await AKN.nsfw.ass(), "ass.jpg"))
    }
    if(Count > 1) 
    {
      let userMSG = message;
      ...
      for(let i = 0; i < Count; i++)
      {
        ...
        .setFile(await AKN.nsfw.ass(), `ass-${i}.jpg`)
        Images.push(IMG)
      }
